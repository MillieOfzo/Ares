...
namespace passwordManager {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class tbl_loginDataTable : global::System.Data.TypedTableBase<tbl_loginRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public tbl_loginRow Addtbl_loginRow(string UserName, string Password, int is_admin) {
        ...
        public partial class tbl_loginRow : global::System.Data.DataRow {
            ...
            public int is_admin {
                get {
                    return ((int)(this[this.tabletbl_login.is_adminColumn]));
                }
                set {
                    this[this.tabletbl_login.is_adminColumn] = value;
                }
            }
...
namespace passwordManager.Database1DataSetTableAdapters {
    ...
    public partial class tbl_loginTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[tbl_login] WHERE (([Id] = @Original_Id) AND ((@IsNull_UserName" +
                " = 1 AND [UserName] IS NULL) OR ([UserName] = @Original_UserName)) AND ([is_admi" +
                "n] = @Original_is_admin))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[tbl_login] ([UserName], [Password], [is_admin]) VALUES (@UserN" +
                "ame, @Password, @is_admin);\r\nSELECT Id, UserName, Password, is_admin FROM tbl_lo" +
                "gin WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[tbl_login] SET [UserName] = @UserName, [Password] = @Password, [is_admin] = @is_admin WHERE (([Id] = @Original_Id) AND ((@IsNull_UserName = 1 AND [UserName] IS NULL) OR ([UserName] = @Original_UserName)) AND ([is_admin] = @Original_is_admin));
SELECT Id, UserName, Password, is_admin FROM tbl_login WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, UserName, Password, is_admin FROM dbo.tbl_login";
        ...
        public virtual int Fill(Database1DataSet.tbl_loginDataTable dataTable) {
        ...
        public virtual Database1DataSet.tbl_loginDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet.tbl_loginDataTable dataTable = new Database1DataSet.tbl_loginDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet.tbl_loginDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_UserName, int Original_is_admin) {
        ...
        public virtual int Insert(string UserName, string Password, int is_admin) {
            if ((UserName == null)) {
        ...
        public virtual int Update(string UserName, string Password, int is_admin, int Original_Id, string Original_UserName, int Original_is_admin, int Id) {
            if ((UserName == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(Original_is_admin));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string UserName, string Password, int is_admin, int Original_Id, string Original_UserName, int Original_is_admin) {
            return this.Update(UserName, Password, is_admin, Original_Id, Original_UserName, Original_is_admin, Original_Id);
        }
    }
